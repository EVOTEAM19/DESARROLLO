-- ============================================
-- SCHEMA COMPLETO FASTIA - DROP + CREATE
-- ============================================
-- Script completo para crear el schema de FastIA desde cero
...
CREATE INDEX idx_blog_posts_order_index ON blog_posts(created_at DESC);
